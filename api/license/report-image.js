/* /api/license/report-image — «../report/image.js» 와 같은 핸들러의 예비 주소.
 *
 * ★왜 두 주소인가 (api/license/godiv-use.js 와 같은 이유, 2026-08-25 선례)
 *   정본 주소는 /api/report/image.js 계열이지만, EC2 어댑터(server/ec2-server.js)가 «새 폴더»를 라우팅하려면
 ...
 */
module.exports = require('../report/image.js');
