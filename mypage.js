...
fetch('data/business.json?v=20260903i').then(function (r) { return r.ok ? r.json() : null; })
...
// 다운로드
fetch('data/downloads.json?v=20260903i').then(function (r) { return r.ok ? r.json() : null; }).then(function (d) {
  var g = (d && d.goditor) || {};
