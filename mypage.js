...
fetch('data/business.json?v=20260902z').then(function (r) { return r.ok ? r.json() : null; })
...
// 다운로드
fetch('data/downloads.json?v=20260902z').then(function (r) { return r.ok ? r.json() : null; }).then(function (d) {
  var g = (d && d.goditor) || {};
